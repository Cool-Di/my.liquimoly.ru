...
$title           = "Фотогалерея Liqui Moly"; // Text to be displayed in browser titlebar
$author          = "Rybber";
...
//LANGUAGE STRINGS
$label_home     = "Галерея Liqui Moly"; //Name of home link in breadcrumb navigation
$label_new      = "Новый"; //Text to display for new images. Use with $display_new variable
$label_page     = "Страница"; //Text used for page navigation
$label_all      = "Все"; //Text used for link to display all images in one page
$label_noimages = "Нет изображений"; //Empty folder text
...
$label_max_length = 150; //Maximum chars of a folder name that will be displayed on the folder thumbnail
$display_exif     = 0;